...
#     result = requests.get(f'https://api.edamam.com/api/recipes/v2?type=public&beta=true&q={recipe_search}&app_id={app_id}&app_key={app_key}').format(ingredient,app_id,app_key)
#     data = result.json()
